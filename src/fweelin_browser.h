...
public:
    ...
    virtual BrowserItemType GetType() {
        return B_Division;
    };
};
...
public:
    ...
    inline char *GetCurName() {
        return rename_tmpbuf;
    };
...
public:
    ...
    inline BrowserItemType GetType() {
        return btype;
    };
    virtual FloDisplayType GetFloDisplayType() {
        return FD_Browser;
    };
    ...
    virtual void Draw_Item(SDL_Renderer *renderer, BrowserItem *i, int x, int y);
...
public:
    ...
    inline PatchBank *GetCurPatchBank() const {
        return pb_cur;
    };
